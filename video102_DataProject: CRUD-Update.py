...
def create_pupil():
    ...
    fathers_name = input("Please enter the father's name: ")

    for p in pupils:
        if name == p["name"] and surname == p["surname"] and fathers_name == p["fathers_name"]:
            print("This pupil already exists.")
            ch = input("Would you like to continue? (y-yes, n-no): ")
            if ch == "n":
                return None

    age = int(input("Please enter the age: "))
    pupil_class = int(input("Please enter the class: "))
...
def pupil_update(pupil):
    ...
    print("6-id number")
    print("=" * 15)
    update_choice = int(input("Please pick something to update: "))
    if update_choice == 1:
        pupil["name"] = input("Please enter the new name: ")
    elif update_choice == 2:
        pupil["surname"] = input("Please enter the new surname: ")
    elif update_choice == 3:
        pupil["fathers_name"] = input("Please enter the new father's name: ")
    elif update_choice == 4:
        pupil["age"] = input("Please enter the new age: ")
    elif update_choice == 5:
        pupil["class"] = input("Please enter the new class: ")
    elif update_choice == 6:
        pupil["id_number"] = input("Please enter the new id number: ")
...
def main():
    while True:
        ...
        print("5 - Exit")
        choice = int(input("Please pick one: "))
